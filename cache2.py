# -*- coding: utf-8 -*-
"""
this copy of cache.py was modified by adding print and logging statements to help diagnose what is happening in
Python statements I have not used before. There is no new functionality being added at this time.
